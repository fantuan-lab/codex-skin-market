...
const EN_UI_COPY = {
  ...
  pricing: {
    ...
    cards: [
      ...
      },
      {
        ...
        title: "Reviewer Pro",
        price: "$19/month",
        copy: "Includes a 14-day trial, evidence-pack downloads, and restricted metadata revisions. Or choose $190/year.",
  ...
  billing: {
    ...
    noTrial: "Your subscription starts immediately at the selected rate. Cancel any time in the Customer Portal.",
...
const ZH_UI_COPY: UiCopy = {
  ...
  pricing: {
    ...
    cards: [
      ...
      { label: "Reviewer Pro", title: "Reviewer Pro", price: "$19/月", copy: "含 14 天免费试用、证据包下载和受限元数据修订。也可选择 $190/年。", action: "开始 14 天试用" },
  ...
  billing: {
    ...
    noTrial: "订阅将按所选价格立即开始；你可以随时在客户门户中取消。",
