...
const EN_UI_COPY = {
  ...
  navigation: {
    ...
    mobileAria: "Mobile section navigation",
    workflow: "Workflow",
    standards: "Standards",
    security: "Security",
    pricing: "Pricing",
    openAnalyzer: "Sign in",
    openAnalyzerShort: "Sign in",
  },
  hero: {
    ...
    secondaryAction: "See the 3-step workflow",
    boundariesAria: "Processing safeguards",
    boundaries: [
      "Local-first processing",
      "SHA-256 version fingerprint",
      "Human review stays explicit",
    ],
    boundaryNote: "Guided remediation—not one-click compliance.",
    preview: {
      aria: "Example remediation evidence record",
      label: "Illustrative UI example · not scan output",
      fileName: "illustrative-review.pdf",
      pageCount: "Example page 12 of 38",
      selectedFinding: "Selected finding",
      title: "Image alternate text is missing",
      copy: "The page exposes an image without equivalent text. A reviewer must confirm intent and write an accurate description.",
      locationLabel: "Example location",
      location: "Page 12 · figure 1",
      methodLabel: "Method",
      method: "Annotation and structure inspection",
      reviewer: "Human review recorded",
      fingerprint: "Illustrative version ID · no source file",
      rows: [
        { label: "Document title", status: "Machine-detected" },
        { label: "Reading order", status: "Human review" },
        { label: "Table headers", status: "Human review" },
      ],
    },
  },
  intake: {
    sectionLabel: "Try the real workflow",
    sectionTitle: "Start with the file. Keep the evidence with every decision.",
    sectionIntro: "Use the local analyzer below or load a fixture. Results come from the PDF bytes in your browser—not a canned score or generated scan.",
  ...
  productProof: {
    ...
    title: "See the issue. Record the judgment. Deliver the evidence.",
    intro: "Each record connects a page location, detection method, reviewer decision, file fingerprint, and version history. The evidence pack documents the work; it is not a certificate.",
    fixtureLabel: "Illustrative evidence anatomy · not scan output",
    pageLabel: "Example page 12",
    pageTitle: "Public notice: service changes",
    pageCopy: "This illustrative layout shows how a machine-detectable signal can be connected to a page location while keeping source files separate from reports.",
    findingLabel: "Example finding CT-ALT-001",
    findingTitle: "Image alternate text is missing",
    findingLocation: "Location · page 12, figure 1",
    findingEvidence: "Evidence · no alternate-text value was exposed",
    findingMethod: "Method · annotation and structure inspection",
    reviewLabel: "Reviewer state",
    reviewTitle: "Needs human verification",
    reviewCopy: "Confirm whether the image is informative or decorative, then record the rationale and responsible reviewer.",
    packTitle: "Evidence pack includes",
    packItems: [
      "Exact file fingerprint and version",
      "Finding location, severity, and method",
      "Automatic and human-review status",
      "Before/after record and declared limits",
    ],
  },
  scope: {
  ...
  standards: {
    ...
    illustrationAlt: "Three reference volumes labeled WCAG 2.2, PDF/UA, and Section 508",
    cards: [
      {
  ...
  pricing: {
    ...
    title: "Keep local PDF review free. Upgrade the delivery tools when you need them.",
    intro: "ClearTag never sends your PDF to Stripe. Stripe processes subscription and billing information only.",
    cards: [
      {
        label: "Free",
        title: "Local review",
        price: "$0",
        copy: "Upload and analyze locally, inspect findings, and record review decisions in your browser.",
      ...
      },
      {
        ...
        title: "Reviewer Pro",
        price: "$19/month",
        copy: "Eligible new subscribers can start with a 14-day trial. Includes evidence-pack downloads and restricted metadata revisions. Or choose $190/year.",
        action: "View Reviewer Pro",
      },
      {
        label: "Later",
        title: "Organization",
        price: "Coming later",
        copy: "Future organization controls, shared workflows, and deployment options. Not available yet.",
        action: "Organization later",
      },
    ],
  },
  finalBoundary: {
  ...
  auth: {
    ...
    title: "Sign in to keep your review workspace private.",
    intro: "Use an email and password or continue with Google. Authentication protects access to the workspace; PDF analysis still happens only in your browser.",
    backHome: "Back to ClearTag",
    languageAria: "Login language",
    formAria: "Account access",
    signInTab: "Sign in",
    signUpTab: "Create account",
    emailLabel: "Work email",
    emailPlaceholder: "name@organization.gov",
    passwordLabel: "Password",
    passwordHint: "Use at least 8 characters when creating an account.",
    showPassword: "Show password",
    hidePassword: "Hide password",
    signInAction: "Sign in with email",
    signUpAction: "Create account with email",
    working: "Please wait…",
    divider: "or",
    ...
    privacyTitle: "What account access changes—and what it does not",
    accountPrivacy: "Supabase processes limited account and session data needed to authenticate you, such as your email address, identity provider, and session identifiers.",
    pdfPrivacy: "Your source PDF, extracted content, findings, and reviewer notes are not sent to Supabase. PDF work remains in this browser tab unless you download an evidence pack.",
    googlePrivacy: "Google sign-in requests basic identity details only. ClearTag does not request access to Google Drive or your Drive files.",
    securityNote: "Use a managed device and follow your organization’s document-handling policy.",
  },
  account: {
    skip: "Skip to PDF workspace",
    brandAria: "ClearTag landing page",
    eyebrow: "Authenticated workspace",
    title: "PDF review workspace",
    intro: "Analyze one PDF at a time in this browser. Signing in controls workspace access; it does not upload or retain your documents.",
    signedInAs: "Signed in as",
    accountMenuAria: "Account and language controls",
    landing: "Return to landing page",
    signOut: "Sign out",
    signingOut: "Signing out…",
    signOutError: "We couldn’t sign you out. Refresh this page and try again.",
    localBadge: "PDFs stay local",
    localNote: "No source PDF or extracted document content is stored with your account. Leaving this workspace or changing its language clears the current in-memory review.",
  },
  billing: {
    eyebrow: "Billing",
    title: "Your ClearTag plan",
    intro: "Choose the tools you need. PDF analysis and review decisions stay local in your browser on every plan.",
    languageAria: "Billing language",
    planLabel: "Current plan",
    free: "Free",
    pro: "Reviewer Pro",
    statusLabel: "Subscription status",
    periodLabel: "Renews or ends",
    monthly: "Monthly",
    annual: "Annual",
    monthlyPrice: "$19/month",
    annualPrice: "$190/year",
    annualNote: "Save $38 compared with monthly billing.",
    trial: "14-day free trial. Cancel before it ends to avoid charges.",
    noTrial: "This account is not eligible for another trial. The selected subscription starts when Checkout confirms payment.",
    activeAccess: "Reviewer Pro access is active.",
    subscribe: "Start 14-day trial",
    subscribeWithoutTrial: "Subscribe to Reviewer Pro",
    manage: "Manage billing",
    processing: "Opening secure billing…",
    ...
    sessionExpired: "Your session expired. Sign in again before opening billing.",
    checkoutConflict: "A subscription or Checkout is already in progress. Refresh billing or use the Customer Portal.",
    checkoutCancelled: "Checkout was canceled. No subscription change was made.",
    checkoutSuccess: "Reviewer Pro is active. Return to your original ClearTag tab to continue the in-memory review.",
    checkoutSuccessPending: "Checkout completed, but Stripe is still updating the subscription. Keep this tab open and refresh shortly.",
    entitlementRefreshed: "Reviewer Pro is unlocked. Your in-memory review is still here.",
    unavailable: "Billing is temporarily unavailable. Local analysis and review decisions remain available.",
    billingActionTitle: "Billing action required",
    billingActionCopy: "Use the Customer Portal to resolve or cancel the existing subscription before starting another.",
    monthlyRenewal: "Stripe Checkout requires a payment method. After an eligible trial, USD $19 is charged each month until canceled.",
    annualRenewal: "Stripe Checkout requires a payment method. After an eligible trial, USD $190 is charged each year until canceled.",
    monthlyImmediateRenewal: "Stripe Checkout requires a payment method. USD $19 is charged immediately, then each month until canceled.",
    annualImmediateRenewal: "Stripe Checkout requires a payment method. USD $190 is charged immediately, then each year until canceled.",
    softwareOnly: "Self-service software only—no human remediation, conformance audit, certification, or legal advice.",
    privacy: "Stripe handles subscription and billing data. Your PDF and its extracted content are never sent to Stripe.",
    status: {
      free: "Free plan",
      inactive: "Free plan",
    ...
    canceling: "Cancels at the end of the current period",
    workspacePlan: "Plan",
    backWorkspace: "Back to workspace",
    upgrade: "Upgrade to Reviewer Pro",
    manageShort: "Manage billing",
    proGateTitle: "Reviewer Pro feature",
    proGateCopy: "Evidence-pack downloads and restricted metadata revisions are available with Reviewer Pro. Local analysis and review decisions remain free.",
    preserveReview: "Billing opens in a new tab so this in-memory review stays here.",
  },
  footer: {
...
const ZH_UI_COPY: UiCopy = {
  ...
  hero: {
    ...
    preview: {
      ...
      label: "界面示意 · 并非扫描结果",
      fileName: "illustrative-review.pdf",
      pageCount: "示例：第 12 页，共 38 页",
      selectedFinding: "当前发现",
      title: "图片缺少替代文本",
      copy: "页面包含未暴露等效文本的图片。复核人员需要确认图片用途，并编写准确描述。",
      locationLabel: "示例位置",
      location: "第 12 页 · 图 1",
      methodLabel: "检测方法",
      method: "批注与结构检查",
      reviewer: "已记录人工复核",
      fingerprint: "示意版本编号 · 无源文件",
      rows: [
        { label: "文档标题", status: "机器检测" },
        { label: "阅读顺序", status: "人工复核" },
        { label: "表格表头", status: "人工复核" },
      ],
    },
  },
  intake: {
    sectionLabel: "体验真实流程",
    sectionTitle: "从文件开始，让证据跟随每一个决定。",
    sectionIntro: "使用下方本地分析器或加载测试样例。结果来自浏览器中的真实 PDF 字节，不是预设分数，也不是生成式扫描。",
    kicker: "本地分析器",
    title: "检查 PDF",
    privacyChip: "浏览器内处理",
  ...
  productProof: {
    label: "为审计而设计",
    title: "看见问题，记录判断，交付证据。",
    intro: "每条记录关联页码位置、检测方法、复核决定、文件指纹和版本历史。证据包用于记录工作，不是合规证书。",
    fixtureLabel: "证据结构示意 · 并非扫描结果",
    pageLabel: "示例第 12 页",
    pageTitle: "公共通知：服务调整",
    pageCopy: "这个界面示意展示机器可检测信号如何关联到页面位置，同时将源文件与报告分开。",
    findingLabel: "示例问题 CT-ALT-001",
    findingTitle: "图片缺少替代文本",
    findingLocation: "位置 · 第 12 页，图 1",
    findingEvidence: "证据 · 未暴露替代文本值",
    findingMethod: "方法 · 批注与结构检查",
    reviewLabel: "复核状态",
    reviewTitle: "需要人工验证",
    reviewCopy: "确认图片是信息性还是装饰性内容，然后记录判断依据和负责的复核人员。",
    packTitle: "证据包包含",
    packItems: [
      "精确的文件指纹与版本",
      "问题位置、严重程度与检测方法",
  ...
  standards: {
    ...
    illustrationAlt: "三本分别标注 WCAG 2.2、PDF/UA 和 Section 508 的标准参考书",
    cards: [
      {
        label: "美国州及地方政府",
        title: "Title II · WCAG 2.1 A / AA",
  ...
  pricing: {
    label: "简单定价",
    title: "本地 PDF 复核永久免费；需要交付工具时再升级。",
    intro: "ClearTag 不会将你的 PDF 发送给 Stripe；Stripe 只处理订阅与账单信息。",
    cards: [
      { label: "免费版", title: "本地复核", price: "$0", copy: "在浏览器中本地上传和分析，查看发现并记录复核决定。", action: "打开工作区" },
      { label: "Reviewer Pro", title: "Reviewer Pro", price: "$19/月", copy: "符合条件的新订阅者可享 14 天免费试用。包含证据包下载和受限元数据修订，也可选择 $190/年。", action: "查看 Reviewer Pro" },
      { label: "后续推出", title: "组织版", price: "即将推出", copy: "未来将提供组织控制、共享工作流和部署选项；目前尚未提供。", action: "组织版后续推出" },
    ],
  },
  finalBoundary: {
    label: "产品承诺",
  ...
  auth: {
    eyebrow: "私有复核工作区",
    title: "登录后，安全访问你的复核工作区。",
    intro: "使用邮箱和密码，或通过 Google 账号继续。身份验证用于保护工作区入口；PDF 分析仍只在你的浏览器中进行。",
    backHome: "返回 ClearTag",
    languageAria: "登录页语言",
    formAria: "账号访问",
    signInTab: "登录",
    signUpTab: "注册账号",
    ...
    emailPlaceholder: "name@organization.gov",
    passwordLabel: "密码",
    passwordHint: "注册账号时，请使用至少 8 个字符的密码。",
    showPassword: "显示密码",
    hidePassword: "隐藏密码",
    signInAction: "使用邮箱登录",
    signUpAction: "使用邮箱注册",
    ...
    privacyTitle: "账号登录会处理什么，不会处理什么",
    accountPrivacy: "Supabase 只处理身份验证所需的有限账号和会话数据，例如邮箱地址、身份提供商和会话标识符。",
    pdfPrivacy: "源 PDF、提取内容、检测结果和复核备注不会发送到 Supabase。除非你下载证据包，PDF 工作只保留在当前浏览器标签页。",
    googlePrivacy: "Google 登录只请求基础身份信息；ClearTag 不申请访问 Google Drive，也不会读取你的云端硬盘文件。",
    securityNote: "请使用受管理的设备，并遵守所在组织的文档处理政策。",
  },
  account: {
    skip: "跳到 PDF 工作区",
    brandAria: "ClearTag 落地页",
    eyebrow: "已验证身份的工作区",
    title: "PDF 复核工作区",
    intro: "在当前浏览器中一次分析一份 PDF。登录只控制工作区访问，不会上传或留存你的文档。",
    signedInAs: "当前登录账号",
    accountMenuAria: "账号与语言控制",
    landing: "返回落地页",
    signOut: "退出登录",
    signingOut: "正在退出…",
    signOutError: "暂时无法退出登录。请刷新页面后重试。",
    localBadge: "PDF 保持本地处理",
    localNote: "源 PDF 和提取出的文档内容不会存入你的账号。离开工作区或切换工作区语言会清除当前内存中的复核状态。",
  },
  billing: {
    eyebrow: "账单",
    title: "你的 ClearTag 方案",
    intro: "按需选择工具。所有方案的 PDF 分析与复核决定都只在浏览器本地进行。",
    languageAria: "账单语言",
    planLabel: "当前方案",
    free: "免费版",
    pro: "Reviewer Pro",
    ...
    monthlyPrice: "$19/月",
    annualPrice: "$190/年",
    annualNote: "相比按月订阅可节省 $38。",
    trial: "14 天免费试用；试用结束前取消即可避免扣费。",
    noTrial: "此账户不能再次试用；Stripe Checkout 确认付款后，所选订阅将立即开始。",
    activeAccess: "Reviewer Pro 权限已生效。",
    subscribe: "开始 14 天试用",
    subscribeWithoutTrial: "订阅 Reviewer Pro",
    manage: "管理账单",
    processing: "正在打开安全账单页面…",
    checkoutError: "无法开始结账，请重试。",
    portalError: "无法打开账单管理，请重试。",
    sessionExpired: "登录会话已过期，请重新登录后再打开账单。",
    checkoutConflict: "已有订阅或结账流程正在进行。请刷新账单状态，或使用客户门户。",
    checkoutCancelled: "结账已取消，订阅没有发生变化。",
    checkoutSuccess: "Reviewer Pro 已生效。请返回原来的 ClearTag 标签页，继续当前内存中的复核。",
    checkoutSuccessPending: "结账已完成，但 Stripe 仍在更新订阅。请保留此标签页并稍后刷新。",
    entitlementRefreshed: "Reviewer Pro 已解锁；当前内存中的复核仍然保留。",
    unavailable: "账单功能暂时不可用；本地分析和复核决定仍可继续使用。",
    billingActionTitle: "需要处理账单",
    billingActionCopy: "请先在客户门户中处理或取消现有订阅，再开始新的订阅。",
    monthlyRenewal: "Stripe Checkout 需要付款方式。符合试用资格时，试用结束后将按每月 USD $19 自动续订，直至取消。",
    annualRenewal: "Stripe Checkout 需要付款方式。符合试用资格时，试用结束后将按每年 USD $190 自动续订，直至取消。",
    monthlyImmediateRenewal: "Stripe Checkout 需要付款方式。将立即扣取 USD $19，此后每月自动续订，直至取消。",
    annualImmediateRenewal: "Stripe Checkout 需要付款方式。将立即扣取 USD $190，此后每年自动续订，直至取消。",
    softwareOnly: "仅提供自助软件，不包含人工修复、符合性审计、认证或法律意见。",
    privacy: "Stripe 处理订阅和账单数据。你的 PDF 及提取内容绝不会发送到 Stripe。",
    status: {
      free: "免费方案",
      inactive: "免费方案",
      trialing: "试用中",
    ...
    canceling: "将在当前订阅周期结束时取消",
    workspacePlan: "方案",
    backWorkspace: "返回工作区",
    upgrade: "升级至 Reviewer Pro",
    manageShort: "管理账单",
    proGateTitle: "Reviewer Pro 功能",
    proGateCopy: "证据包下载和受限元数据修订仅限 Reviewer Pro。免费版仍可本地分析并做出复核决定。",
    preserveReview: "账单会在新标签页打开，因此当前内存中的复核会保留。",
  },
  footer: {
