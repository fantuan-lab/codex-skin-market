((cssText, artDataUrl, themeConfig) => {
  ...
  const applyTheme = (root, shell) => {
    ...
    const accent = colors.accent || (shell === "light" ? "#7763c8" : "#8b84ff");
    const accentAlt = colors.accentAlt || accent;
    const secondary = colors.secondary || (shell === "light" ? "#bdb5ec" : "#67e8ff");
    const highlight = colors.highlight || (shell === "light" ? "#6553b2" : "#f3cc8b");
    ...
    if (shell === "light") {
      ...
      variables = {
        ...
        "--ds-text": "#25213a",
        "--ds-muted": "#746f8e",
        "--ds-line": colors.line || "rgba(110, 96, 194, .22)",
      };
    } else {
      variables = {
